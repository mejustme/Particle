...
psParticle.prototype.move = function() {
    ...
    for (var f = 0; f < a.width; f += d.ptlGap + 1)
        for (var g = 0; g < a.height; g += d.ptlGap + 1)
            i = (g * a.width + f) * 4, a.data[i + 3] > 0 && e.push({x: b + f,y: c + g,color: d.monochrome == !0 ? [d.colorArr[0], d.colorArr[1], d.colorArr[2], d.colorArr[3]] : [a.data[i], a.data[i + 1], a.data[i + 2], a.data[i + 3]]});
    return e
    ...
    a.cw = a.getCw();
    a.ch = a.getCh();
    a.$canv.width = a.cw, a.$canv.height = a.ch, a.init()
